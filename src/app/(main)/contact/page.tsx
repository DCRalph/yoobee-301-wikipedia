          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {/* Contact Info Cards */}
                <div className="group rounded-xl border-2 border-[#e8e0d6] bg-gradient-to-br from-white to-[#faf7f3] p-6 shadow-lg transition-all duration-300 hover:scale-105 hover:border-[#d4c4b0] hover:shadow-xl active:scale-95">
                  <div className="flex items-center space-x-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#8b6c55] to-[#6b4c35] text-white transition-all duration-200 group-hover:from-[#a67c5a] group-hover:to-[#8b6c55]">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-xl border-2 border-[#e8e0d6] bg-gradient-to-br from-white to-[#faf7f3] p-8 shadow-lg transition-all duration-300 hover:border-[#d4c4b0] hover:shadow-xl">
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="block w-full rounded-xl border-2 border-[#e8e0d6] bg-gradient-to-br from-white to-[#faf7f3] px-4 py-3 text-[#3b2a1a] shadow-sm transition-all duration-200 placeholder:text-[#6b4c35]/60 hover:border-[#d4c4b0] focus:border-[#8b6c55] focus:ring-2 focus:ring-[#8b6c55]/20 focus:outline-none"
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger className="w-full !h-12 rounded-xl border-2 border-[#e8e0d6] bg-gradient-to-br from-white to-[#faf7f3] px-4 py-3 text-[#3b2a1a] shadow-sm transition-all duration-200 hover:border-[#d4c4b0] focus:border-[#8b6c55] focus:ring-2 focus:ring-[#8b6c55]/20 focus:outline-none [&>span]:text-[#6b4c35]/60 data-[state=open]:border-[#8b6c55]">
                        <SelectValue placeholder="Select a subject" />
                      </SelectTrigger>
                      <SelectContent className="rounded-xl border-2 border-[#e8e0d6] bg-gradient-to-br from-white to-[#faf7f3] shadow-xl">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      className="block w-full rounded-xl border-2 border-[#e8e0d6] bg-gradient-to-br from-white to-[#faf7f3] px-4 py-3 text-[#3b2a1a] shadow-sm transition-all duration-200 placeholder:text-[#6b4c35]/60 hover:border-[#d4c4b0] focus:border-[#8b6c55] focus:ring-2 focus:ring-[#8b6c55]/20 focus:outline-none resize-none"
                    />
                  </div>
